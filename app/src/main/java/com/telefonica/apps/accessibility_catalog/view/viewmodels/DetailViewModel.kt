...
import com.telefonica.apps.accessibility_catalog.domain.GetAccessibilityDetailUseCase
...
class DetailViewModel @Inject constructor(
    private val getAccessibilityDetailUseCase: GetAccessibilityDetailUseCase,
) : ViewModel() {
